...
rights-intro-point-2 = Вам не передаються жодні права на торговельну марку чи ліцензії на торговельні марки BrowserWorks або будь-якої сторони, включно та без обмежень на назву і логотип Waterfox. Додаткову інформацію щодо торговельних марок можна знайти <a data-l10n-name="mozilla-trademarks-link">тут</a>.
